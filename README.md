...
当前电脑已安装 Tailscale 时，服务会在“邀请另一半”中优先列出 `100.x.x.x` 私网地址。另一半需安装 Tailscale，并接受这台电脑的设备分享邀请；之后双方可异地访问，清单不会公开到普通互联网。电脑仍需开机，Tailscale 与本地服务均需运行。Windows 入站规则应仅对 Tailscale 私人接口开放 TCP 8765。
